 ...
 didFinishPickingMediaWithInfo: (NSDictionary*) info
{
	...
	NSString *urlString = [NSString stringWithFormat:@"http://apiprom/promout/%@.json", ticketId];
	...
	if(error) {
		...
		NSString *returnStr = [NSString stringWithFormat:@"%@ has checked out of prom with ticket number: %@", name, ticketId];
