 ...
 didFinishPickingMediaWithInfo: (NSDictionary*) info
{
	...
	NSString *urlString = [NSString stringWithFormat:@"http://apiprom/ppromout/%@.json", ticketId];
	...
	if(error) {
		...
		NSString *returnStr = [NSString stringWithFormat:@"%@ has checked out of post prom with ticket number: %@", name, ticketId];
