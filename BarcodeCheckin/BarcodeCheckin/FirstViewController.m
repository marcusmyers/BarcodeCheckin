 ...
 didFinishPickingMediaWithInfo: (NSDictionary*) info
{
	...
	NSString *urlString = [NSString stringWithFormat:@"http://apiprom/promin/%@.json", ticketId];
...
//		NSLog(@"The response: %@",jsonDict);
		...
		NSString *returnStr = [NSString stringWithFormat:@"%@ has checked into prom with ticket number: %@", name, ticketId];
